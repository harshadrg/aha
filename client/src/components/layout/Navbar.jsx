...
import { MenuOpen, MenuClose } from '../ui/Icons';
...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-black/90 backdrop-blur-md border-b border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" className="text-neutral-300 hover:text-white !rounded-full px-5 py-2">
              Sign In
            </Button>
        ...
        <div className="md:hidden bg-neutral-900 border-b border-neutral-800">
          <div className="px-2 pt-2 pb-4 space-y-1">
            ...
            <div className="mt-4 pt-4 border-t border-neutral-800 grid gap-2 px-3">
              <Button variant="secondary" className="w-full justify-center !rounded-full py-3">Sign In</Button>
